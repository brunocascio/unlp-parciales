...
<div class="row">
  <div class="col-lg-6 col-md-12">
    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
      ...
      <input
        ...
        name="name"
        class="form-control"
        value="{{ $resource->name or old('name') }}"
        minlength="4"
        maxlength="100"
        required>
      @if ($errors->has('name'))
  ...
  <div class="col-lg-3 col-md-6">
    <div class="form-group {{ $errors->has('resource_date') ? 'has-error' : '' }}">
      ...
      <input
        ...
        name="resource_date"
        class="form-control"
        value="{{ $resource->resource_date or old('resource_date') }}"
        required>
  ...
  <div class="col-lg-3 col-md-6">
    <div class="form-group {{ $errors->has('type_id') ? 'has-error' : '' }}">
      ...
      <select class="form-control selectpicker" name="type_id" data-live-search="true" required>
        <option></option>
  ...
  <div class="col-lg-4 col-md-6">
    <div class="form-group {{ $errors->has('course_id') ? 'has-error' : '' }}">
      ...
      <select class="form-control selectpicker" name="course_id" data-live-search="true" required>
        <option></option>
